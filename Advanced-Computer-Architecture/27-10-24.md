...
<mxfile host="app.diagrams.net">
  <diagram name="Page-1" id="HqrfN9lzIcBfLZrB42mp">
    <mxGraphModel dx="827" dy="596" grid="1" gridSize="10" guides="1" tooltips="1" connect="1" arrows="1" fold="1" page="1" pageScale="1" pageWidth="827" pageHeight="1169" math="0" shadow="0">
      <root>
        <mxCell id="0" parent="1" />
        <mxCell id="1" parent="0" />
        
        <!-- Inputs -->
        <mxCell id="A0" value="Input A0" style="text;html=1;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;whiteSpace=wrap;rounded=0;" vertex="1" parent="1">
          <mxGeometry x="160" y="40" width="80" height="30" />
        </mxCell>
        <mxCell id="A1" value="Input A1" style="text;html=1;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;whiteSpace=wrap;rounded=0;" vertex="1" parent="1">
          <mxGeometry x="160" y="80" width="80" height="30" />
        </mxCell>
        <mxCell id="D2_4" value="2x4 Decoder" style="rounded=1;whiteSpace=wrap;html=1;" vertex="1" parent="1">
          <mxGeometry x="280" y="60" width="120" height="50" />
        </mxCell>

        <!-- Additional XML Elements Here -->
